...
public class LogInForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabelKorisnickoIme.setText("Unesite korisnicko ime:");

        jLabelLozinka.setText("Unesite lozinku:");

        jLabel1.setText("Softver za pracenje angazovanja studenata u kompanijama");

        jLabel2.setText("Filip Nedovic 185/13");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(jTextFieldLozinka, javax.swing.GroupLayout.PREFERRED_SIZE, 142, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String email = jTextFieldKorisnickoIme.getText();
        String lozinka = jTextFieldLozinka.getText();
        Zaposleni zaposleni = new Zaposleni(0, email, lozinka);
        try {
            boolean uspesnost = Controler.getInstance().ulogujSe(zaposleni);
            if(uspesnost) {
                new MainForm(zaposleni).setVisible(true);
                this.dispose();
            } else {
                JOptionPane.showMessageDialog(this, "Zaposleni ne postoji u bazi!");
            }
